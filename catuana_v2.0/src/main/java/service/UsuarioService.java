...
//		System.out.println(request.body());
        ...
        String medicoString = request.queryParams("medico");
        Boolean medico = Boolean.parseBoolean(medicoString);

        Usuario usuario;
        usuario = new Usuario(nome, cpf, email, celular, senha, false, medico);
        ...
        public JSONArray getAll (Request request, Response response){
            ...
            return allUsuarios == null ? new JSONArray() : allUsuarios;
        }
        ...
        public JSONArray getAllByNome (Request request, Response response){
            ...
            for (Usuario i : usuarioDAO.getAllByNome()) {
